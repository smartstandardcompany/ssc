...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/order-tracking', icon: Truck, label: 'Order Tracking', perm: 'sales', roles: ['admin', 'manager'] },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/menu-analytics', icon: BarChart3, label: 'Menu Analytics', perm: 'stock', roles: ['admin', 'manager'] },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/duplicate-report', icon: Copy, label: 'Duplicate Report', perm: 'reports', roles: ['admin'] },
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/scheduled-reports', icon: CalendarClock, label: 'Scheduled Reports', perm: 'settings', roles: ['admin'] },
