...
import { Plus, Edit, Trash2, DollarSign, AlertTriangle, Eye, Calendar } from 'lucide-react';
          ...
          <DialogContent className="max-w-3xl max-h-[85vh] overflow-y-auto" data-testid="summary-dialog">
            ...
            {empSummary && (
              <Tabs defaultValue="payments">
                <TabsList className="mb-4"><TabsTrigger value="payments">Salary & Payments</TabsTrigger><TabsTrigger value="loan">Loan / Advance</TabsTrigger><TabsTrigger value="leave">Leave Records</TabsTrigger></TabsList>
