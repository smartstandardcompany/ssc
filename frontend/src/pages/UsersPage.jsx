    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
          <div>
            <h1 className="text-2xl sm:text-4xl font-bold font-outfit mb-2" data-testid="users-page-title">User Management</h1>
            <p className="text-muted-foreground text-sm">Manage users and granular access control</p>
          </div>
