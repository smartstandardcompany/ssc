...
import { ArrowDownUp, Plus, Trash2, TrendingUp, TrendingDown, DollarSign, ChevronDown, ChevronRight, Percent } from 'lucide-react';
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start gap-3">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Track platform sales vs received payments — see what each platform cuts</p>
          </div>
        ...
        {/* Grand Summary Cards */}
        {summary && (
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3" data-testid="platform-grand-summary">
            ...
            <Card className="bg-gradient-to-br from-red-50 to-white border-red-200">
              <CardContent className="p-4">
                <div className="text-[10px] text-red-600 uppercase tracking-wider">Platform Cuts (Total)</div>
                ...
                {summary.total_online_sales > 0 && (
                  <div className="text-xs text-red-500 mt-0.5">
                    {((summary.total_platform_cut / summary.total_online_sales) * 100).toFixed(1)}% average cut
                  </div>
                )}
              </CardContent>
            </Card>
                  ...
                  <div className="p-4 cursor-pointer hover:bg-stone-50 transition-colors"
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-semibold text-base">{platform.platform_name}</div>
                      ...
                      <div className="flex items-center gap-4 text-sm">
                        ...
                        <div className="text-right">
                          <div className="text-xs text-red-500">Platform Cut</div>
        ...
        <Dialog open={showReceiveDialog} onOpenChange={setShowReceiveDialog}>
          <DialogContent data-testid="receive-payment-dialog">
            <DialogHeader>
              <DialogTitle className="font-outfit">Record Platform Payment</DialogTitle>
            </DialogHeader>
            <form onSubmit={handleReceive} className="space-y-4">
              <div>
                <Label>Platform *</Label>
                <Select value={receiveForm.platform_id || "none"} onValueChange={v => setReceiveForm({ ...receiveForm, platform_id: v === "none" ? "" : v })}>
