                  ...
                  {s ? (
                    <div className="space-y-3">
                      <div className="flex items-center justify-between p-2 bg-success/10 rounded">
                        ...
                        <span className="text-sm font-bold text-success">SAR {s.total_sales.toFixed(2)}</span>
                      </div>
                      <div className="flex items-center justify-between p-2 bg-error/10 rounded">
                        ...
                        <span className="text-sm font-bold text-error">SAR {s.total_expenses.toFixed(2)}</span>
                      </div>
                      <div className="flex items-center justify-between p-2 bg-info/10 rounded">
                        ...
                        <span className="text-sm font-bold text-info">SAR {s.total_supplier_payments.toFixed(2)}</span>
                      </div>
                      <div className="flex items-center justify-between p-2 bg-primary/10 rounded border border-primary/20">
                        ...
                        <span className={`text-sm font-bold ${s.net_profit >= 0 ? 'text-success' : 'text-error'}`}>SAR {s.net_profit.toFixed(2)}</span>
                      </div>
            ...
            {showDetail && (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-success/10 rounded-lg"><div className="text-xs text-muted-foreground">Total Sales</div><div className="text-lg font-bold text-success">SAR {showDetail.total_sales.toFixed(2)}</div><div className="text-xs">{showDetail.sales_count} transactions</div></div>
                  <div className="p-3 bg-error/10 rounded-lg"><div className="text-xs text-muted-foreground">Total Expenses</div><div className="text-lg font-bold text-error">SAR {showDetail.total_expenses.toFixed(2)}</div><div className="text-xs">{showDetail.expenses_count} transactions</div></div>
                  <div className="p-3 bg-info/10 rounded-lg"><div className="text-xs text-muted-foreground">Supplier Payments</div><div className="text-lg font-bold text-info">SAR {showDetail.total_supplier_payments.toFixed(2)}</div><div className="text-xs">{showDetail.sp_count} transactions</div></div>
                  <div className="p-3 bg-primary/10 rounded-lg"><div className="text-xs text-muted-foreground">Net Profit</div><div className={`text-lg font-bold ${showDetail.net_profit >= 0 ? 'text-success' : 'text-error'}`}>SAR {showDetail.net_profit.toFixed(2)}</div></div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-cash/10 rounded-lg border border-cash/30"><div className="text-xs text-muted-foreground">Cash In Hand</div><div className={`text-lg font-bold ${(showDetail.cash_in_hand || 0) >= 0 ? 'text-cash' : 'text-error'}`}>SAR {(showDetail.cash_in_hand || 0).toFixed(2)}</div></div>
                  <div className="p-3 bg-bank/10 rounded-lg border border-bank/30"><div className="text-xs text-muted-foreground">Bank In Hand</div><div className={`text-lg font-bold ${(showDetail.bank_in_hand || 0) >= 0 ? 'text-bank' : 'text-error'}`}>SAR {(showDetail.bank_in_hand || 0).toFixed(2)}</div></div>
                </div>
                <div className="border-t pt-3">
                  <h4 className="text-sm font-medium mb-2">Sales Breakdown</h4>
                  <div className="grid grid-cols-3 gap-2">
                    <div className="p-2 bg-cash/10 rounded text-center"><div className="text-xs text-muted-foreground">Cash</div><div className="text-sm font-bold text-cash">SAR {showDetail.sales_cash.toFixed(2)}</div></div>
                    <div className="p-2 bg-bank/10 rounded text-center"><div className="text-xs text-muted-foreground">Bank</div><div className="text-sm font-bold text-bank">SAR {showDetail.sales_bank.toFixed(2)}</div></div>
                    <div className="p-2 bg-credit/10 rounded text-center"><div className="text-xs text-muted-foreground">Credit</div><div className="text-sm font-bold text-credit">SAR {showDetail.sales_credit.toFixed(2)}</div></div>
                  </div>
                </div>
                <div className="border-t pt-3">
                  <h4 className="text-sm font-medium mb-2">Expenses Breakdown</h4>
                  <div className="grid grid-cols-2 gap-2">
                    <div className="p-2 bg-cash/10 rounded text-center"><div className="text-xs text-muted-foreground">Cash</div><div className="text-sm font-bold text-cash">SAR {showDetail.expenses_cash.toFixed(2)}</div></div>
                    <div className="p-2 bg-bank/10 rounded text-center"><div className="text-xs text-muted-foreground">Bank</div><div className="text-sm font-bold text-bank">SAR {showDetail.expenses_bank.toFixed(2)}</div></div>
                  </div>
                </div>
              </div>
            )}
